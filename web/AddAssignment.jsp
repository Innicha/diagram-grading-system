...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Diagram Grading System</title>
        ...
        <div class="container my-4" style="max-width: 960px;">
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <div>
                        <h3 class="fw-bold mb-1">Assignment</h3>
                        <p class="text-muted mb-0">เลือกและสร้างโจทย์</p>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4 align-items-center">
                    <div class="col-8 col-md-9">
                        <div class="input-group">
                            <input type="text" class="form-control border-start-0 ps-0 py-2" placeholder="ค้นหาโจทย์...">
                    ...
                    <div class="col-4 col-md-3">
                        <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2 py-2 fw-medium">
                            ...
                            <span class="d-none d-sm-inline">สร้างโจทย์</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <a href="CreateAnswerKey_Flowchart.jsp" class="section-card">
                        <div class="d-flex align-items-center gap-3">
                            <div class="folder-icon-box">
                                <i class="bi bi-folder-fill"></i>
                            </div>
                            <div>
                                <h5 class="fw-bold mb-1">Compro-1-1</h5>
                                <p class="text-muted small mb-2">Design Flowchart</p>
                                <div class="meta-info">
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="#" class="section-card">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="fw-bold mb-1">Compro-1-2</h5>
                                <p class="text-muted small mb-2">Design Flowchart</p>
                                <div class="meta-info">
                                </div>
                            </div>
                    ...
                    <a href="#" class="section-card">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="fw-bold mb-1">Compro-1-3</h5>
                                <p class="text-muted small mb-2">Design Flowchart</p>
                                <div class="meta-info">
                                </div>
                            </div>
